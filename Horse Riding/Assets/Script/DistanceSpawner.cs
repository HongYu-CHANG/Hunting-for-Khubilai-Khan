...
namespace ZenvaVR
{
    ...
    public class DistanceSpawner : MonoBehaviour
    {
        ...
        void Spawn()
        {
			...
			//set position
			newObj.transform.position = new Vector3(transform.position.x + UnityEngine.Random.Range(-100.0f, 100.0f), transform.position.y + 10f, transform.position.z + UnityEngine.Random.Range(-100.0f, 100.0f));
